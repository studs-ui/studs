...
export const SupplementalColorStyles = () => (
  <DesignGuideTable
    title="Supplemental"
    data={{
      columns: [
      ...
      rows: [
        [
          ...
          {
            content: <SampleColor background="rgba(52, 120, 120, 1)" type="circle" />,
          },
          {
        ...
        [
          ...
          },
          {
            content: (
              <SampleColor
                background="rgba(52, 120, 120, 0.3)"
                type="circle"
              />
            ),
          },
        ...
        [
          ...
          },
          {
            content: (
              <SampleColor
                background="rgba(52, 120, 120, 0.5)"
                type="circle"
              />
            ),
          },
