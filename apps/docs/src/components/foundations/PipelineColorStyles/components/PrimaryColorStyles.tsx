    ...
    data={{
      ...
      rows: [
        [
          ...
          {
            content: <SampleColor background="var(--e-business-primary, #657682)" type="circle" />,
          },
          {
        ...
        [
          ...
          },
          {
            content: (
              <SampleColor
                background="var(--light-primary-shades-4-p, rgba(52, 120, 120, 0.13))"
                type="circle"
              />
            ),
          },
        ...
        [
          ...
          },
          {
            content: (
              <SampleColor
                background="var(--light-primary-shades-8-p, rgba(52, 120, 120, 0.08))"
                type="circle"
              />
            ),
          },
