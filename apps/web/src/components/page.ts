...
<button slot="tablist">Grids</button>
  <div slot="Grids">
    <div class="group">
      <h2>Usage</h2>
      <presentational-usage> <studs-grid wrapperprops="{'style': {'width': '100%', 'margin': 'auto', 'height': '100%'}}" tablecaption="Local Data Grid" pagesize="25" .itemsperpageselector=${[
        10, 25, 50, 100,
      ]} showborders="true" allowcolumnresizing="true" enableglobalsearch="true"></studs-grid></presentational-usage>
    </div>
    <div class="group">
      <div class="componentGrid -single">
        <presentational-component>
      ...
      10, 25, 50, 100,
    ]} showborders="true" allowcolumnresizing="true" enableglobalsearch="true" .columns=${[
      {
        key: 'id',
        label: 'Id',
...
<button slot="tablist">Switches</button>
  <div slot="Switches">
    ...
    <div class="group">
      <div class="componentGrid">
        <presentational-component>
          <studs-switch checked="true" label="Checked" @switch-change=${(
            e: CustomEvent
          ) =>
            console.log(`Switch changed! Checked status: ${e.detail.checked}`)}
            ></studs-switch>
        </presentational-component>
        <presentational-component>
  ...
  <div slot="Inputs">
    ...
    <div class="group">
      <div class="componentGrid">
        ...
        <presentational-component>
          <studs-input autocomplete="off" name="fname" type="text" value="John" label="Adornment End" variant="outlined" input-size="normal" adornment="lbs" adornment-position="end" @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}"></studs-input>
        </presentational-component>
        <presentational-component>
          <studs-input type="email" name="email" label="Email" variant="outlined" @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}"></studs-input>
        </presentational-component>
        <presentational-component>
          <studs-input type="search" name="search" label="Search" variant="outlined" @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}"></studs-input>
        </presentational-component>
        <presentational-component>
          <studs-input type="number" name="number" label="Number" variant="outlined" @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}"></studs-input>
        </presentational-component>
        <presentational-component>
          <studs-input type="password" name="password" label="Password" variant="outlined" @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}"></studs-input>
        </presentational-component>
      </div>
...
<button slot="tablist">Textarea</button>
  <div slot="Textarea">
    ...
    <div class="group">
      <div class="componentGrid">
        <presentational-component>
          <studs-textarea label="With Label and Placeholder" placeholder="Enter your text here" @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}">
          </studs-textarea>
        </presentational-component>
        <presentational-component>
          <studs-textarea label="With Character counter" placeholder="Enter your text here" character-counter @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}">
          </studs-textarea>
        </presentational-component>
        <presentational-component>
          <studs-textarea label="Required" placeholder="Enter your text here" required @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}">
          </studs-textarea>
        </presentational-component>
        <presentational-component>
          <studs-textarea label="Disabled" placeholder="Enter your text here" disabled @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}">
          </studs-textarea>
        </presentational-component>
        <presentational-component>
          <studs-textarea label="With custom rows and cols" placeholder="Enter your text here" rows="8" cols="60" @change="${(
            e: CustomEvent
          ) => console.log('Selected value:', e.detail)}">
          </studs-textarea>
        </presentational-component>
        <presentational-component>
          <studs-textarea label="With Error and Helper Text" placeholder="Enter your text here" maxlength="2" error messagetype="error" .helperText=${[
            'First error',
            'Second error',
